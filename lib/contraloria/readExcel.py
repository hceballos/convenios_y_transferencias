...
class ReadExcel():
	...
	def parse_Excel(self, datos):
		...
		for f in glob.glob(datos['contraloria']): # '../convenios_y_transferencias/input_excel/AnalisisRetenidos/*',
	...
	def crear_database(self, devengo):
		...
		engine = sqlalchemy.create_engine('sqlite:///contraloria.db', echo=False)
		metadata = sqlalchemy.MetaData()
